...
Consider the binary tree whose nodes correspond to $(a,b)$ with $\gcd(a,b)=1$. Its root is $(1,1)$, and the left child of $(a,b)$ is $(a,a+b)$ and the right child $(a+b,b)$. Shown below is $\nu=\pi/2$.
\begin{center}
\begin{asy}
