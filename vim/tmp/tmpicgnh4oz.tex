...
\newcommand{\@voncore}[2]{
	...
	\ifvonbrave
	\immediate\write\@vonfile{env PYTHONPATH=/home/evan/Documents/Projects/
	python3 -m von show "#2" --brave -b #1 > `dirname $0`/_v\@vonname.out}%
	\else
	\immediate\write\@vonfile{env PYTHONPATH=/home/evan/Documents/Projects/
	python3 -m von show "#2" -b #1 > `dirname $0`/_v\@vonname.out}%
	\fi
