...
\paragraph{Second solution, by moving points}     Animate $X$ at a linear rate on the tangent to $(AMN)$ at $A$, and let $\omega_B$ intersect $\seg{BC}$ at $R\ne B$.
